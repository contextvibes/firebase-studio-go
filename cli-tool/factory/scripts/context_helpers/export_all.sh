...
# Point to the correct root-level Go source files and directories.
append_book "The Products (Deployable Code)" "cmd/" "go.mod" "main.go"
append_book "The Factory (Automation Framework)" "factory/" "Taskfile.yml"
append_book "The Library (Project Documentation)" "docs/" "README.md"
